...
<report name="ordrs" DTDVersion="9.0.2.0.10">
...
<p><hr><p>
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL ORDERS.ORDER_ID, ORDERS.ORDER_DATE, ORDERS.CUST_ID, ORDERS.EMP_ID
FROM ORDERS ]]>
      </select>
      ...
      <group name="G_ORDER_ID">
        ...
        <dataItem name="ORDER_ID" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Order Id">
          <dataDescriptor expression="ORDERS.ORDER_ID"
        ...
        <dataItem name="ORDER_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Order Date">
          <dataDescriptor expression="ORDERS.ORDER_DATE"
           descriptiveExpression="ORDER_DATE" order="2" width="9"/>
        </dataItem>
        <dataItem name="CUST_ID" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Cust Id">
          <dataDescriptor expression="ORDERS.CUST_ID"
           descriptiveExpression="CUST_ID" order="3" width="22" precision="6"
          />
        </dataItem>
        <dataItem name="EMP_ID" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Emp Id">
          <dataDescriptor expression="ORDERS.EMP_ID"
           descriptiveExpression="EMP_ID" order="4" width="22" precision="6"/>
        </dataItem>
      </group>
    </dataSource>
  </data>
  ...
  <section name="main">
    <body>
      <frame name="M_G_ORDER_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="4.93750" height="0.37500"
        />
        ...
        <repeatingFrame name="R_G_ORDER_ID" source="G_ORDER_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="4.93750"
           height="0.18750"/>
          ...
          <field name="F_ORDER_DATE" source="ORDER_DATE" alignment="start">
            <font face="Arial" size="10"/>
            <geometryInfo x="1.18750" y="0.18750" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_CUST_ID" source="CUST_ID" alignment="start">
            <font face="Arial" size="10"/>
            <geometryInfo x="2.56250" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_EMP_ID" source="EMP_ID" alignment="start">
            <font face="Arial" size="10"/>
            <geometryInfo x="3.75000" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_ORDER_ID_HDR">
          <geometryInfo x="0.00000" y="0.00000" width="4.93750"
           height="0.18750"/>
          ...
          <text name="B_ORDER_DATE">
            <geometryInfo x="1.18750" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="Arial" size="10" bold="yes" textColor="r100g100b100"
          ...
          <text name="B_CUST_ID">
            <geometryInfo x="2.56250" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="Arial" size="10" bold="yes" textColor="r100g100b100"
          ...
          <text name="B_EMP_ID">
            <geometryInfo x="3.75000" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="Arial" size="10" bold="yes" textColor="r100g100b100"
...
B4E51F60 4000B300 C000A300 C310C040 10300000 0992CD80 00000000 00000000
09F51370 00000000 C2311EB0 00000000 8C005000 B4006100 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
84E51370 C42C1370 11006400 82008040 00203300 014D3F50 00000000 00000000
00000000 00000000 00000000 00000000 F1000000 20004100 00000000 36000000
00000000 00000000 00000000 00000000 F1000000 4000FFFF 00000000 36000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 C0002210 BD10C040 10300000 0452CD80
00000000 00000000 87061370 00000000 C2311EB0 00000000 A110C300 22006100
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00161370 80751370 89357270 1100E210 7D008040 00203300 014D3F50
00000000 36000000 00000000 00000000 00000000 00000000 F1000000 20005000
00000000 36000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 C000F310 6C10C040
20300000 00000000 00000000 00000000 06161370 00000000 C2311EB0 00000000
C3100000 AE008B00 00000000 46004600 FFFF0000 33008B00 8B00FFFF 00002000
8E161370 0D261370 00000000 00000000 81061370 47061370 B400B410 2F008040
0D303300 0D303300 00000000 00000000 00000000 00000000 00000000 00000000
F1000000 20000000 00000000 36000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
A3001100 5E00C040 84303300 81051370 00000000 00000000 84261370 00000000
C2311EB0 00000000 50000000 F500D000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 0D261370 00000000 FFFFFFFF
1100C000 19008040 00203300 014D3F50 00000000 36000000 00000000 00000000
00000000 00000000 F1000000 20005000 00000000 36000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
...
<rw:dataArea id="MGORDERIDGRPFR235">
<table class="OraTable">
<caption> orders </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBORDERID235" asArray="no"/> class="OraColumnHeader"> Order Id </th>
   <th <rw:id id="HBORDERDATE235" asArray="no"/> class="OraColumnHeader"> Order Date </th>
   <th <rw:id id="HBCUSTID235" asArray="no"/> class="OraColumnHeader"> Cust Id </th>
   <th <rw:id id="HBEMPID235" asArray="no"/> class="OraColumnHeader"> Emp Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGORDERID2351" src="G_ORDER_ID">
   <tr>
    <td <rw:headers id="HFORDERID235" src="HBORDERID235"/> class="OraCellNumber"><rw:field id="FORDERID235" src="ORDER_ID" nullValue="&nbsp;"> F_ORDER_ID </rw:field></td>
    <td <rw:headers id="HFORDERDATE235" src="HBORDERDATE235"/> class="OraCellText"><rw:field id="FORDERDATE235" src="ORDER_DATE" nullValue="&nbsp;"> F_ORDER_DATE </rw:field></td>
    <td <rw:headers id="HFCUSTID235" src="HBCUSTID235"/> class="OraCellNumber"><rw:field id="FCUSTID235" src="CUST_ID" nullValue="&nbsp;"> F_CUST_ID </rw:field></td>
    <td <rw:headers id="HFEMPID235" src="HBEMPID235"/> class="OraCellNumber"><rw:field id="FEMPID235" src="EMP_ID" nullValue="&nbsp;"> F_EMP_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
