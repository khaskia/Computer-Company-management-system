...
<report name="suppliersreport" DTDVersion="9.0.2.0.10">
...
<p><hr><p>
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL STORE_ITEM.ITEM_ID, STORE_ITEM.ITEM_NAME, STORE_ITEM.ITEM_PRICE, STORE_ITEM.AVAILABLE_AMOUNT, 
STORE_ITEM.ITEM_DESCRIPTION, STORE_ITEM.SUP_ID
FROM STORE_ITEM ]]>
      </select>
      ...
      <group name="G_SUP_ID">
        ...
        />
        <dataItem name="SUP_ID" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Sup Id">
          <dataDescriptor expression="STORE_ITEM.SUP_ID"
           descriptiveExpression="SUP_ID" order="6" width="22" precision="6"/>
        </dataItem>
      </group>
      <group name="G_ITEM_ID">
        <displayInfo x="1.08435" y="3.13965" width="1.83142" height="1.15942"
        />
        <dataItem name="ITEM_ID" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Item Id">
          <dataDescriptor expression="STORE_ITEM.ITEM_ID"
           descriptiveExpression="ITEM_ID" order="1" width="22" precision="6"
          />
        </dataItem>
        <dataItem name="ITEM_NAME" datatype="vchar2" columnOrder="12"
         width="100" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Item Name">
          <dataDescriptor expression="STORE_ITEM.ITEM_NAME"
           descriptiveExpression="ITEM_NAME" order="2" width="100"/>
        </dataItem>
        <dataItem name="ITEM_PRICE" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Item Price">
          <dataDescriptor expression="STORE_ITEM.ITEM_PRICE"
           descriptiveExpression="ITEM_PRICE" order="3" width="22"
           precision="6"/>
        </dataItem>
        <dataItem name="AVAILABLE_AMOUNT" oracleDatatype="number"
         columnOrder="14" width="22" defaultWidth="60000"
         defaultHeight="10000" columnFlags="33"
         defaultLabel="Available Amount">
          <dataDescriptor expression="STORE_ITEM.AVAILABLE_AMOUNT"
           descriptiveExpression="AVAILABLE_AMOUNT" order="4" width="22"
           precision="4"/>
        </dataItem>
        <dataItem name="ITEM_DESCRIPTION" datatype="vchar2" columnOrder="15"
         width="300" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Item Description">
          <dataDescriptor expression="STORE_ITEM.ITEM_DESCRIPTION"
           descriptiveExpression="ITEM_DESCRIPTION" order="5" width="300"/>
        </dataItem>
      </group>
    </dataSource>
  </data>
    ...
    <body>
      <frame name="M_G_SUP_ID_GRPFR">
        ...
        <repeatingFrame name="R_G_SUP_ID" source="G_SUP_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <frame name="M_G_ITEM_ID_GRPFR">
            <geometryInfo x="1.25000" y="0.37500" width="6.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_ITEM_ID" source="G_ITEM_ID"
             printDirection="down" minWidowRecords="1" columnMode="no">
              ...
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              <field name="F_ITEM_ID" source="ITEM_ID" alignment="start">
                <font face="Arial" size="10"/>
                <geometryInfo x="1.25000" y="0.37500" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_ITEM_NAME" source="ITEM_NAME" alignment="start">
                <font face="Arial" size="10"/>
                <geometryInfo x="2.43750" y="0.37500" width="1.43750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              ...
              <field name="F_AVAILABLE_AMOUNT" source="AVAILABLE_AMOUNT"
               alignment="start">
                <font face="Arial" size="10"/>
              ...
              <field name="F_ITEM_DESCRIPTION" source="ITEM_DESCRIPTION"
               alignment="start">
                <font face="Arial" size="10"/>
                <geometryInfo x="6.00000" y="0.37500" width="1.43750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
          </frame>
          <field name="F_SUP_ID" source="SUP_ID" alignment="start">
        ...
        <frame name="M_G_SUP_ID_HDR">
          ...
          <text name="B_ITEM_ID">
            <geometryInfo x="1.25000" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
          ...
          <text name="B_ITEM_NAME">
            <geometryInfo x="2.43750" y="0.00000" width="1.43750"
             height="0.18750"/>
          ...
          <text name="B_ITEM_PRICE">
            <geometryInfo x="3.87500" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="Arial" size="10" bold="yes" textColor="r100g100b100"
          ...
          <text name="B_ITEM_DESCRIPTION">
            <geometryInfo x="6.00000" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="Arial" size="10" bold="yes" textColor="r100g100b100"
...
5EBCBDEF AF7FFB00 E00B0870 C406ED60 4000B300 064B4480 00000000 36000000
00000000 00000000 00000000 00000000 F1000000 2000A000 00000000 36000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 C000D100 CF10C040 10300000 E7AFE980
00000000 00000000 8DA20580 00000000 23901A80 00000000 00006400 7A100A00
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 09920580 00002000 11009200 8E008040 00203300 064B4480
00000000 36000000 00000000 00000000 00000000 00000000 F1000000 20000000
00000000 36000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 E4000610 9D108040
00000000 00000000 2B000000 02E20580 E3000000 E3000000 10000000 30000000
D000B000 30005000 00008000 6A100000 00000000 00000000 10000000 10000000
00000000 00000000 00000000 10000000 49000000 49200000 49300000 49600000
00000000 00000000 0DD20580 07602820 EA00B300 B3001000 10000000 00000000
00000000 0F004900 00004900 B3000000 1000C000 10000010 10100090 E08121C1
E2C20000 E2C20000 C2000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00004200 00000000 00000000 00420000
00000000 00000000 D2000000 00000000 00000000 00000000 00000000 4444D2D4
F4E4D225 25000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 8484E2D4 94E23535
85646402 14D40000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 4444D2D4 F4E4D225 25028484 E2D494E2 35358564 640214D4
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 8484E2D4 94E23535
85646402 14D40245 A5250000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 0000
  ...
  <reportPrivate defaultReportType="tabBrkLeft" templateName="rwblue"/>
</report>
</rw:objects>
-->
...
<TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
  ...
  <TR> 
    <TD bgColor=#ffffff rowSpan=2 vAlign=center width=188> 
      <p><IMG src="images/rwblue_logo.gif" width="135" height="36"><br>
      </p>
    </TD>
...
<rw:dataArea id="MGSUPIDGRPFR201">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBSUPID201" asArray="no"/> class="OraColumnHeader"> Sup Id </th>
   <th <rw:id id="HBITEMID201" asArray="no"/> class="OraColumnHeader"> Item Id </th>
   <th <rw:id id="HBITEMNAME201" asArray="no"/> class="OraColumnHeader"> Item Name </th>
   <th <rw:id id="HBITEMPRICE201" asArray="no"/> class="OraColumnHeader"> Item Price </th>
   <th <rw:id id="HBAVAILABLEAMOUNT201" asArray="no"/> class="OraColumnHeader"> Available
Amount </th>
   <th <rw:id id="HBITEMDESCRIPTION201" asArray="no"/> class="OraColumnHeader"> Item Description </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGSUPID2011" src="G_SUP_ID">
   <rw:foreach id="RGITEMID2011" src="G_ITEM_ID">
    <tr>
     <td <rw:id id="HFSUPID201" breakLevel="RGSUPID2011" asArray="no"/> class="OraRowHeader"><rw:field id="FSUPID201" src="SUP_ID" breakLevel="RGSUPID2011" breakValue="&nbsp;"> F_SUP_ID </rw:field></td>
     <td <rw:headers id="HFITEMID201" src="HBITEMID201, HBSUPID201, HFSUPID201"/> class="OraCellNumber"><rw:field id="FITEMID201" src="ITEM_ID" nullValue="&nbsp;"> F_ITEM_ID </rw:field></td>
     <td <rw:headers id="HFITEMNAME201" src="HBITEMNAME201, HBSUPID201, HFSUPID201"/> class="OraCellText"><rw:field id="FITEMNAME201" src="ITEM_NAME" nullValue="&nbsp;"> F_ITEM_NAME </rw:field></td>
     <td <rw:headers id="HFITEMPRICE201" src="HBITEMPRICE201, HBSUPID201, HFSUPID201"/> class="OraCellNumber"><rw:field id="FITEMPRICE201" src="ITEM_PRICE" nullValue="&nbsp;"> F_ITEM_PRICE </rw:field></td>
     <td <rw:headers id="HFAVAILABLEAMOUNT201" src="HBAVAILABLEAMOUNT201, HBSUPID201, HFSUPID201"/> class="OraCellNumber"><rw:field id="FAVAILABLEAMOUNT201" src="AVAILABLE_AMOUNT" nullValue="&nbsp;"> F_AVAILABLE_AMOUNT </rw:field></td>
     <td <rw:headers id="HFITEMDESCRIPTION201" src="HBITEMDESCRIPTION201, HBSUPID201, HFSUPID201"/> class="OraCellText"><rw:field id="FITEMDESCRIPTION201" src="ITEM_DESCRIPTION" nullValue="&nbsp;"> F_ITEM_DESCRIPTION </rw:field></td>
    </tr>
   </rw:foreach>
  </rw:foreach>
 </tbody>
